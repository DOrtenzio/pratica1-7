...
if(isset($_POST["id_prestito"]) && !empty($_POST["id_prestito"]) && isset($_POST["id_libro"]) && !empty($_POST["id_libro"]) && isset($_POST["id_utente"]) && !empty($_POST["id_utente"]) && isset($_POST["data_inizio"]) && !empty($_POST["data_inizio"]) && isset($_POST["data_fine_prevista"]) && !empty($_POST["data_fine_prevista"])){
